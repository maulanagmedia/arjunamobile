...
public class Converter {
    ...
    private static SimpleDateFormat d_format2 = new SimpleDateFormat("dd-MM-yyyy", Locale.getDefault());
    ...
    public static Date stringDToDateReversed(String date){
        try {
            return d_format2.parse(date);
        } catch (ParseException e) {
            e.printStackTrace();
            return new Date();
        }
    ...
    public static String TToString(int hour, int minute){
    ...
    public static String DToStringReversed(Date date){
        return d_format2.format(date);
    }
